...
-- Software Development with Claude Code / Module 2: Your First Webpage
-- Replaces markdown glossary "**Term** — Definition" with "**Term**: Definition",
-- and general prose " — " with ", ". Titles use " - " (spaced hyphen).

update lessons set content = $Dc327d634_a4d3_410f_8bf2_00179d3574d6$Your page now exists and looks better. But it does not respond to the user yet.
...
If the button does nothing, check: Is script.js saved? Is the script tag included just before the closing body tag? Does the button ID in HTML match exactly what getElementById is looking for? Capitalization matters, helloButton is not the same as HelloButton.$Dc327d634_a4d3_410f_8bf2_00179d3574d6$ where id = 'c327d634-a4d3-410f-8bf2-00179d3574d6';

update lessons set content = $D81678f12_231d_4e02_91cb_3fd9782e1f12$So far, you created a simple webpage manually. Now we will use Claude Code as a building partner.
...
Check: Is the page clear? Is the text readable? Does the button look clickable? Is there enough spacing? Does it work on a smaller browser width? Is the code still understandable?$D81678f12_231d_4e02_91cb_3fd9782e1f12$ where id = '81678f12-231d-4e02-91cb-3fd9782e1f12';

update lessons set content = $Dbb2e5179_3236_4671_9e5f_7f9e553e81f2$Sometimes your page will break. The button may stop working. The CSS may not load. The layout may look strange.
...
If you are stuck, take a screenshot and show it to Claude or ChatGPT. Ask: "I am stuck here. Look at this screenshot and tell me what is wrong and what I should do next." Modern builders do not guess blindly.$Dbb2e5179_3236_4671_9e5f_7f9e553e81f2$ where id = 'bb2e5179-3236-4671-9e5f-7f9e553e81f2';

update lessons set content = $D4f206b1e_a09a_434a_9d88_a78a6f60b80b$You built your first webpage. Now save a checkpoint.
...
**git push:** Sends commits to GitHub.$D4f206b1e_a09a_434a_9d88_a78a6f60b80b$ where id = '4f206b1e-a09a-434a-9d88-a78a6f60b80b';

update lessons set content = $D8461b4bd_5a6c_4150_948a_0d8c1703c84f$>> A webpage is just a file that your browser knows how to read.
...
For now, your webpage will live only on your computer. That means only you can see it. Later, in the deployment module, you will put it online so anyone can visit it.$D8461b4bd_5a6c_4150_948a_0d8c1703c84f$ where id = '8461b4bd-5a6c-4150-948a-0d8c1703c84f';

update lessons set content = $Dc7ad381e_a31d_494f_b27e_5e1327963a06$Now we will create your first webpage manually.
...
If the browser shows a blank page, check: Did you save the file? Is the file named exactly index.html? Did you paste the code inside the file? Did you open the correct file?$Dc7ad381e_a31d_494f_b27e_5e1327963a06$ where id = 'c7ad381e-a31d-494f-b27e-5e1327963a06';

update lessons set content = $D01c00999_d8c9_4727_8be0_b73a506cc501$Every beginner should understand this clearly before writing more code.
...
**Frontend:** The visible part of a website or app that runs in the browser.$D01c00999_d8c9_4727_8be0_b73a506cc501$ where id = '01c00999-d8c9-4727-8be0-b73a506cc501';

update lessons set content = $Df944e256_fdeb_42c2_9b43_577f013e4569$Your webpage works, but it probably looks plain. That is normal.
...
If your CSS does not apply, check: Is the file named exactly style.css? Did you save it? Is the link tag inside the head section of index.html? Are both files in the same folder?$Df944e256_fdeb_42c2_9b43_577f013e4569$ where id = 'f944e256-fdeb-42c2-9b43-577f013e4569';

update lessons set content = $D9f84751f_996d_4873_9863_8640c72bdb9e$Now you will finish your first webpage. This does not need to be perfect. It needs to be complete, working, and understandable.
...
[!] You completed Module 2. You now understand: HTML creates structure, CSS controls appearance, JavaScript adds behavior, Claude Code helps you build faster, debugging means describing the problem clearly, and Git saves working checkpoints. You did not just read about software, you made something real.$D9f84751f_996d_4873_9863_8640c72bdb9e$ where id = '9f84751f-996d-4873-9863-8640c72bdb9e';

update questions set choices = $Dc10a006c_cb82_4768_bbb7_eb5f6aa1a52aQ$["Only at the very end of the project","Whenever the project reaches a working checkpoint","Before creating any file","Never, just save the files"]$Dc10a006c_cb82_4768_bbb7_eb5f6aa1a52aQ$::jsonb where id = 'c10a006c-cb82-4768-bbb7-eb5f6aa1a52a';
