...
update modules set description = $M$When customization is actually worth it, model selection dimensions, fine-tuning vs. RAG vs. tools vs. traditional ML, data quality, evaluation, safety, and launch discipline for custom models.$M$ where id = '89ff2f0d-ff4c-46d1-b0ac-824ac24fa88b';

update lessons set content = $D9e7d1997_de07_4506_afb5_b7c4db435371$Before customizing a model, climb this ladder: use a good base model, improve the prompt, add examples, add structured output, add RAG or context, add tools or APIs, route tasks to different models, use a smaller or larger model, fine-tune, and only then train a custom model.
...
>> This ladder is the whole module compressed into ten steps, everything after this lesson is detail on when and how to climb the later rungs.$D9e7d1997_de07_4506_afb5_b7c4db435371$ where id = '9e7d1997-de07-4506-afb5-b7c4db435371';

update lessons set content = $De4b7e530_a7f6_4666_8236_4b0f39480ae3$Business problem: analysts ask questions in English, and AI generates SQL.
...
>> This example is a clean illustration of the whole module's thesis: fine-tuning handles the repeatable pattern (how we phrase SQL), while RAG and tools handle everything that changes (the schema itself).$De4b7e530_a7f6_4666_8236_4b0f39480ae3$ where id = 'e4b7e530-a7f6-4666-8236-4b0f39480ae3';

update lessons set content = $D51e4b11d_c239_48f6_b963_8ad5c66ad9e4$DATA LABELING FOR FINE-TUNING
...
>> Labeling discipline determines the ceiling on fine-tuning quality; example count mostly determines how close you can get to that ceiling.$D51e4b11d_c239_48f6_b963_8ad5c66ad9e4$ where id = '51e4b11d-c239-48f6-b963-8ad5c66ad9e4';

update lessons set content = $D544744fa_e65a_4273_a95c_da2c6d3e982a$WHY THIS MODULE MATTERS
...
>> Fine-tuning is the last rung on the ladder, not the first thing to reach for when output quality is disappointing.$D544744fa_e65a_4273_a95c_da2c6d3e982a$ where id = '544744fa-e65a-4273-a95c-da2c6d3e982a';

update lessons set content = $Dffdbbc09_e769_4c86_ada7_c60d9716c22c$WHAT IS MODEL SELECTION?
...
>> "Which model is best" is the wrong question. "Which model is best for this specific task, at this cost and latency" is the right one.$Dffdbbc09_e769_4c86_ada7_c60d9716c22c$ where id = 'ffdbbc09-e769-4c86-ada7-c60d9716c22c';

update lessons set content = $De810285f_3113_4d97_8cce_09d53ae56e38$When choosing a model, compare these dimensions.
...
>> Most model comparisons stop at quality. A real model selection decision runs through all twelve dimensions above before committing.$De810285f_3113_4d97_8cce_09d53ae56e38$ where id = 'e810285f-3113-4d97-8cce-09d53ae56e38';

update lessons set content = $D88e32102_c6df_4584_8490_193d37d53877$PMs do not need to know every model name, but they should understand model categories.
...
>> Knowing the seven categories above is usually enough for a PM to spot when "just use the LLM" is the wrong plan.$D88e32102_c6df_4584_8490_193d37d53877$ where id = '88e32102-c6df-4584-8490-193d37d53877';

update lessons set content = $D3ad77efd_23a9_4a5b_94cc_da1bb62d2617$WHAT IS FINE-TUNING?
...
>> Fine-tuning's sweet spot is narrow, repeatable, well-defined behavior, not broad intelligence or up-to-date knowledge.$D3ad77efd_23a9_4a5b_94cc_da1bb62d2617$ where id = '3ad77efd-23a9-4a5b-94cc-da1bb62d2617';

update lessons set content = $D898c5f4a_692d_4727_8248_bf8b2b92de57$WHAT FINE-TUNING IS NOT GOOD FOR
...
>> If the failure is "the model does not know X," ask whether X changes, if it does, that is a RAG problem wearing a fine-tuning costume.$D898c5f4a_692d_4727_8248_bf8b2b92de57$ where id = '898c5f4a-692d-4727-8248-bf8b2b92de57';

update lessons set content = $D359767cc_fa31_43d6_bab1_bc66b0bd0797$PROMPTING VS. FINE-TUNING
...
>> Before fine-tuning, check whether the model is seeing the right context, a model missing the right information will fail no matter how much it is retrained.$D359767cc_fa31_43d6_bab1_bc66b0bd0797$ where id = '359767cc-fa31-43d6-bab1-bc66b0bd0797';

update lessons set content = $Dd39fb900_30e3_41d3_9324_b9964f3a64aa$FINE-TUNING VS. TOOLS
...
>> Two very different "no" answers: fine-tuning cannot substitute for a live tool call, and training from scratch is almost never the right scope for a product team.$Dd39fb900_30e3_41d3_9324_b9964f3a64aa$ where id = 'd39fb900-30e3-41d3-9324-b9964f3a64aa';

update lessons set content = $D84529ee1_f346_4c65_96c4_b6cc148e5b7f$SUPERVISED FINE-TUNING
...
>> Four different tools for four different jobs: supervised for "do this," preference for "prefer this over that," parameter-efficient for "cheaply," and full fine-tuning for "thoroughly, at a price."$D84529ee1_f346_4c65_96c4_b6cc148e5b7f$ where id = '84529ee1-f346-4c65-96c4-b6cc148e5b7f';

update lessons set content = $D2729f38d_a851_4b26_abd9_b99062140a04$SUPERVISED FINE-TUNING IN SIMPLE WORDS
...
>> Supervised fine-tuning needs a correct answer for each example. Preference tuning only needs a comparison, which is often easier to produce reliably for subjective qualities like tone.$D2729f38d_a851_4b26_abd9_b99062140a04$ where id = '2729f38d-a851-4b26-abd9-b99062140a04';

update lessons set content = $D9e721453_6cf2_4c5f_972b_85c744276700$PARAMETER-EFFICIENT TUNING IN SIMPLE WORDS
...
>> Parameter-efficient tuning lowers the cost of the "when to fine-tune" decision. It does not change the underlying question of whether fine-tuning is the right fix in the first place.$D9e721453_6cf2_4c5f_972b_85c744276700$ where id = '9e721453-6cf2-4c5f-972b-85c744276700';

update lessons set content = $Dcabbced4_0be4_4527_939c_98bcd7ffb8b0$FINE-TUNING EXAMPLE: SUPPORT TICKET CLASSIFICATION
...
>> Both examples share a shape: fine-tuning fixes the pattern-recognition part of the task, while validation and tools still handle the parts that need to be exactly right.$Dcabbced4_0be4_4527_939c_98bcd7ffb8b0$ where id = 'cabbced4-0be4-4527-939c-98bcd7ffb8b0';

update lessons set content = $D8b3edf2e_57ac_40be_9922_5d9082c1f080$FINE-TUNING EXAMPLE: BRAND VOICE
...
>> Fine-tuning is often an optimization strategy, not only a quality strategy, sometimes the goal is not "better," it's "just as good, for a fraction of the cost."$D8b3edf2e_57ac_40be_9922_5d9082c1f080$ where id = '8b3edf2e-57ac-40be-9922-5d9082c1f080';

update lessons set content = $D97cfee89_66be_4e86_9e9f_450ba48202c6$WHEN RAG IS BETTER THAN FINE-TUNING
...
>> RAG wins when knowledge is the problem. Prompting wins when the task is still evolving. Fine-tuning waits until neither of those is true anymore.$D97cfee89_66be_4e86_9e9f_450ba48202c6$ where id = '97cfee89-66be-4e86-9e9f-450ba48202c6';

update lessons set content = $Dca017982_810a_4f83_abea_e4de70cee054$WHEN TOOLS ARE BETTER THAN FINE-TUNING
...
>> Tools solve "the model doesn't know this fact." Traditional ML solves "this isn't really a language problem in the first place."$Dca017982_810a_4f83_abea_e4de70cee054$ where id = 'ca017982-810a-4f83-abea-e4de70cee054';

update lessons set content = $D323cd4dd_eaea_4e61_9f00_bc975a0106a7$WHEN DETERMINISTIC SOFTWARE IS BETTER
...
>> This lesson closes the loop on the whole "what should we use" question, sometimes the answer is no AI at all, and routing is how a single product applies the right answer to each part of a task.$D323cd4dd_eaea_4e61_9f00_bc975a0106a7$ where id = '323cd4dd-eaea-4e61-9f00-bc975a0106a7';

update lessons set content = $D36b01cde_9000_446c_84d4_2d4a5c316a8d$PMs often need to decide whether to use a commercial AI API, use an open-source model, fine-tune a model, build a custom model, or buy a vertical AI product.
...
>> Five options, one underlying question: does building or customizing this actually create an advantage, or would the same effort be better spent on the workflow around it?$D36b01cde_9000_446c_84d4_2d4a5c316a8d$ where id = '36b01cde-9000-446c-84d4-2d4a5c316a8d';

update lessons set content = $D6f987b9f_d289_464a_9c7f_f99c5694af52$CLOSED/COMMERCIAL MODEL
...
>> This decision rarely has a universally correct answer, it hinges on whether your team's scarce resource is engineering time or model control.$D6f987b9f_d289_464a_9c7f_f99c5694af52$ where id = '6f987b9f-d289-464a-9c7f-f99c5694af52';

update lessons set content = $De046f2d3_e225_4783_811b_87eaa2c07088$MODEL EVALUATION BEFORE SELECTION
...
>> Vibe-based model selection ("this one felt smarter in the demo") is exactly the trap a golden dataset exists to prevent.$De046f2d3_e225_4783_811b_87eaa2c07088$ where id = 'e046f2d3-e225-4783-811b-87eaa2c07088';

update lessons set content = $Da98b7f6a_f28d_4067_9625_7c2a133337e7$OVERFITTING IN FINE-TUNING
...
>> Overfitting is a training-time failure that shows up as weak test performance. Regression testing is how you catch it, along with any other capability that quietly got worse.$Da98b7f6a_f28d_4067_9625_7c2a133337e7$ where id = 'a98b7f6a-f28d-4067-9625-7c2a133337e7';

update lessons set content = $Dcd84994b_7bb4_472b_9f8a_31e91a548ce9$CATASTROPHIC FORGETTING
...
>> Catastrophic forgetting is the general version of this problem (any capability can degrade); safety is the specific version that matters most to test for explicitly.$Dcd84994b_7bb4_472b_9f8a_31e91a548ce9$ where id = 'cd84994b-7bb4-472b-9f8a-31e91a548ce9';

update lessons set content = $Dcd805eb3_cd45_4158_8082_c48748407dc5$FINE-TUNING AND PRIVACY
...
>> Privacy asks what is in the training data. Compliance asks what happens because of the model's decisions. A high-risk domain needs both questions answered carefully.$Dcd805eb3_cd45_4158_8082_c48748407dc5$ where id = 'cd805eb3-cd45-4158-8082-c48748407dc5';

update lessons set content = $D16681a9e_f1ea_4e35_a61b_0e30f0423ee0$LAUNCH STRATEGY FOR FINE-TUNED MODELS
...
>> Launch strategy controls how fast risk is introduced. Monitoring controls how fast a problem is noticed once it exists. A fine-tuned model needs both, permanently, not just at launch.$D16681a9e_f1ea_4e35_a61b_0e30f0423ee0$ where id = '16681a9e-f1ea-4e35-a61b-0e30f0423ee0';

update lessons set content = $D5f05eeec_05f4_4106_abad_97c6c7f0f64c$MODEL VERSIONING
...
>> Versioning is what makes the cost-benefit calculation honest over time, without it, you cannot tell whether today's model is even the one your original evaluation was measuring.$D5f05eeec_05f4_4106_abad_97c6c7f0f64c$ where id = '5f05eeec-05f4-4106-abad-97c6c7f0f64c';

update lessons set content = $D1d25e519_acec_420d_a77d_c55885d3bad1$Use case: support ticket classification.
...
>> This is the concrete version of the cost-benefit lesson before it: the same nine-percentage-point improvement is either a rounding error or a major win, depending entirely on volume.$D1d25e519_acec_420d_a77d_c55885d3bad1$ where id = '1d25e519-acec-420d-a77d-c55885d3bad1';

update lessons set content = $D4363ffe1_b17f_43d5_b551_71e94b87e6e9$MODEL SELECTION EXAMPLE: SUPPORT COPILOT
...
>> Neither example picks one method and calls it done, production-grade AI products are usually a combination, not a single technique.$D4363ffe1_b17f_43d5_b551_71e94b87e6e9$ where id = '4363ffe1-b17f-43d5-b551-71e94b87e6e9';

update lessons set content = $Df0c9b3e3_5800_4357_b169_3ba30a45790d$MODEL SELECTION EXAMPLE: INVOICE EXTRACTION
...
>> Invoice extraction shows fine-tuning working alongside validation. Product recommendations shows an LLM playing a supporting role to a different core model entirely.$Df0c9b3e3_5800_4357_b169_3ba30a45790d$ where id = 'f0c9b3e3-5800-4357-b169-3ba30a45790d';

update lessons set content = $D4101b212_5221_4455_8cbb_4d2f6a55bf21$Ask this in order:
...
>> If you remember nothing else from this module, remember to ask these eight questions in order before reaching for fine-tuning.$D4101b212_5221_4455_8cbb_4d2f6a55bf21$ where id = '4101b212-5221-4455-8cbb-4d2f6a55bf21';

update lessons set content = $D3e30c7e4_3258_4b0f_af85_b48bb8d2ea77$PM CHECKLIST BEFORE FINE-TUNING
...
>> Two checklists, same spirit: write down the actual questions before committing engineering time, rather than discovering the gaps after launch.$D3e30c7e4_3258_4b0f_af85_b48bb8d2ea77$ where id = '3e30c7e4-3258-4b0f-af85-b48bb8d2ea77';

update lessons set content = $Db1a31e02_d663_440c_9c7b_299779b7c492$HOW TO EXPLAIN FINE-TUNING TO LEADERSHIP
...
>> The most important PM question: are we choosing the simplest, safest, most cost-effective AI method that solves the actual failure mode?$Db1a31e02_d663_440c_9c7b_299779b7c492$ where id = 'b1a31e02-d663-440c-9c7b-299779b7c492';

update questions set choices = $Dbabec0f6_bf30_408e_ac5b_e06c61630789Q$["No, prompting is the better choice while requirements are still uncertain and changing often, since prompting allows fast iteration; fine-tuning is better suited to a task that is stable and has settled requirements","Yes, fine-tuning should always happen as early as possible in a project regardless of how unstable requirements are","Yes, since frequently changing requirements are exactly the situation fine-tuning is designed to handle","This decision has nothing to do with how stable the requirements are"]$Dbabec0f6_bf30_408e_ac5b_e06c61630789Q$::jsonb where id = 'babec0f6-bf30-408e-ac5b-e06c61630789';

update questions set choices = $Dd654dc3f_d56e_4a49_8f4d_60282f386fc7Q$["Fine-tuning should not be the first response, the better first question is what exactly is failing and what is the cheapest, safest way to fix it, since the cause could be a vague prompt, missing knowledge, weak retrieval, the wrong model, or several other issues fine-tuning would not fix","Fine-tuning is always the correct first response to poor AI output, regardless of the root cause","This approach is fine as long as the team has a large enough budget for fine-tuning","Poor output can only ever be fixed through fine-tuning, with no other possible causes or solutions"]$Dd654dc3f_d56e_4a49_8f4d_60282f386fc7Q$::jsonb where id = 'd654dc3f-d56e-4a49-8f4d-60282f386fc7';

update questions set choices = $D3f95b0d8_4564_43a7_97ed_1a4c949a902eQ$["Bigger models are not always better, they can be more expensive, slower, and unnecessary for simple tasks like ticket classification, where a smaller model may work well; the goal is to use the smallest, cheapest, fastest model that meets the quality bar safely","This default is correct, since the largest model always produces the best results for every task type","Model size has no effect on cost or latency, so this default carries no real tradeoff","Simple classification tasks always require the largest available model to work correctly"]$D3f95b0d8_4564_43a7_97ed_1a4c949a902eQ$::jsonb where id = '3f95b0d8-4564-43a7-97ed-1a4c949a902e';

update questions set choices = $D424d3132_cb04_4f49_bc04_f709088dbb2aQ$["Model selection should compare across multiple dimensions, including cost, latency, context window, tool use, structured output ability, safety, and compliance, not just quality alone, since a model that scores well on a generic benchmark may still fail on dimensions the specific product actually depends on","Quality score alone is a sufficient and complete basis for model selection in every case","Cost and latency are engineering concerns that should never factor into a PM's model selection decision","Structured output ability and tool use are irrelevant to model selection regardless of the product's needs"]$D424d3132_cb04_4f49_bc04_f709088dbb2aQ$::jsonb where id = '424d3132-cb04-4f49-bc04-f709088dbb2a';

update questions set choices = $Deb440bed_f5e3_4bed_94a7_eab343e66449Q$["An embedding model, this lesson specifically identifies embedding models as good for semantic search, RAG retrieval, similarity, and clustering, which is a better fit for search matching than a general chat-oriented LLM","A speech/audio model, since audio models are the most versatile category for any search-related task","There is no meaningful difference between model families, so the default choice is equally appropriate","A reasoning model is always the correct choice for search tasks regardless of the underlying need"]$Deb440bed_f5e3_4bed_94a7_eab343e66449Q$::jsonb where id = 'eb440bed-f5e3-4bed-94a7-eab343e66449';

update questions set choices = $D33089baf_3a99_43de_a2d5_798c2771dce7Q$["Several cheaper, lower-risk rungs on the ladder, improving the prompt, adding examples, adding structured output, and adding RAG or tools all come before fine-tuning, and skipping straight to fine-tuning means skipping past several genuinely simpler potential fixes","This is the correct approach, since fine-tuning should always be attempted before any other method","The ladder recommends fine-tuning as the very first step for any quality problem","There is no meaningful order to these methods, so skipping steps has no consequence"]$D33089baf_3a99_43de_a2d5_798c2771dce7Q$::jsonb where id = '33089baf-3a99-43de-a2d5-798c2771dce7';

update questions set choices = $Df380007b_34a0_44a7_8b6d_71a95258a70eQ$["Fine-tuning is good for teaching repeated behavior (like classification or consistent formatting), not for knowledge that changes, since policies change over time, baking the current policy into the model's weights via fine-tuning will become outdated and hard to maintain","Fine-tuning is an ideal way to keep the model updated on facts that change frequently, like company policy","This is a good use case for fine-tuning as long as the model is retrained every single day","Fine-tuning and knowledge freshness are unrelated concepts that do not interact in any way"]$Df380007b_34a0_44a7_8b6d_71a95258a70eQ$::jsonb where id = 'f380007b-34a0-44a7-8b6d-71a95258a70e';

update questions set choices = $D58ae1837_d52a_4f7b_8b33_f0d1110af10fQ$["Use RAG instead of fine-tuning, since the document changes often, fine-tuning becomes hard to maintain, while RAG retrieves external knowledge at runtime, keeping answers current without needing constant retraining","Fine-tuning is the recommended approach for any document, regardless of how frequently it changes","RAG and fine-tuning always produce identical results, so either approach works equally well here","Neither RAG nor fine-tuning can help with frequently-changing documents, and no AI-based solution exists"]$D58ae1837_d52a_4f7b_8b33_f0d1110af10fQ$::jsonb where id = '58ae1837-d52a-4f7b-8b33-f0d1110af10f';

update questions set choices = $De1dd9d91_a217_4932_816d_cba7f44d6ae7Q$["Fine-tuning is not appropriate here, the model needs a tool like an order lookup to get the actual live order status, since fine-tuning cannot make a model know real-time, live information like a specific order's current status","Fine-tuning is the correct solution, since fine-tuning can teach the model to know live, real-time order status","This question requires training a completely new model from scratch rather than fine-tuning or tools","This is exactly the kind of task fine-tuning excels at compared to using a tool"]$De1dd9d91_a217_4932_816d_cba7f44d6ae7Q$::jsonb where id = 'e1dd9d91-a217-4932-816d-cba7f44d6ae7';

update questions set choices = $D2ba99882_afb1_4978_b269_be7816b00191Q$["Preference tuning, it uses comparisons between better and worse outputs (which humans can judge even for subjective qualities like tone) rather than requiring one single \"correct\" labeled answer, which supervised fine-tuning needs","Supervised fine-tuning is always the better choice regardless of how subjective the desired output is","Parameter-efficient tuning is specifically designed only for subjective tasks like tone and style","Full fine-tuning is required whenever the task involves any subjective judgment"]$D2ba99882_afb1_4978_b269_be7816b00191Q$::jsonb where id = '2ba99882-afb1-4978-b269-be7816b00191';

update questions set choices = $Dfc40c281_4182_4e3a_928c_706d50fb0673Q$["Supervised fine-tuning, it works by providing input-output examples (like a customer message mapped to the correct category, urgency, and summary), which is exactly the labeled-example structure described in this lesson","Preference tuning is the better fit, since it is designed specifically for cases with clear correct labels","This task cannot be addressed by any type of fine-tuning described in this lesson","Parameter-efficient tuning and supervised fine-tuning are mutually exclusive and cannot both apply to labeled data"]$Dfc40c281_4182_4e3a_928c_706d50fb0673Q$::jsonb where id = 'fc40c281-4182-4e3a-928c-706d50fb0673';

update questions set choices = $D21ee980c_1171_4469_8e1a_63912db21dffQ$["Parameter-efficient tuning, it adapts large models by updating only a relatively small subset of parameters, making it more resource-efficient than full fine-tuning, which fits a limited compute budget better","Full fine-tuning is the only option available for customizing model behavior under a limited budget","Preference tuning always requires more compute than any other fine-tuning method, regardless of budget","Compute budget has no bearing on which fine-tuning technique is appropriate to use"]$D21ee980c_1171_4469_8e1a_63912db21dffQ$::jsonb where id = '21ee980c-1171-4469-8e1a-63912db21dff';

update questions set choices = $D622a93db_d745_4cfb_9820_abbdd2b27b8aQ$["Messy, inconsistent behavior, since a model trained on messy examples will learn messy behavior, inconsistent labels will teach the model to be inconsistent in the same way the training data was inconsistent","The model will automatically resolve the inconsistencies and learn only the correct pattern regardless of label quality","Label consistency has no effect on what the fine-tuned model learns","The model will simply ignore all inconsistently labeled examples during training without any negative effect"]$D622a93db_d745_4cfb_9820_abbdd2b27b8aQ$::jsonb where id = '622a93db-d745-4cfb-9820-abbdd2b27b8a';

update questions set choices = $D203d609f_57b2_4ed6_80fc_a849f62b36baQ$["Yes, this matches the support ticket classification example closely: labels are defined, historical tickets exist, correct outputs are available, the task repeats at high volume, and the output format is structured, all of which are the conditions where fine-tuning tends to help","No, fine-tuning is never appropriate for classification tasks regardless of available labeled data","This scenario requires structured extraction instead of fine-tuning, and fine-tuning would not apply here","Fine-tuning would only help if the task involved unstructured invoice documents rather than support tickets"]$D203d609f_57b2_4ed6_80fc_a849f62b36baQ$::jsonb where id = '203d609f-57b2-4ed6-80fc-a849f62b36ba';

update questions set choices = $Dfcdf08db_9d33_4413_aae0_d5610b71a7dfQ$["Fine-tuning for brand voice depends on having many approved examples and quality that can be judged reliably, without enough approved examples or reliable quality judgment, this is not yet a good fit for fine-tuning, even though brand voice is generally a reasonable fine-tuning use case","Fine-tuning should proceed immediately regardless of example availability or ability to judge quality","Brand voice fine-tuning never requires any approved examples to be effective","This scenario is identical to the smaller-model-optimization example and should be approached the same way"]$Dfcdf08db_9d33_4413_aae0_d5610b71a7dfQ$::jsonb where id = 'fcdf08db-9d33-4413-aae0-d5610b71a7df';

update questions set choices = $D3e9c7a91_7ff1_4d9f_a835_a7e2211b8f4fQ$["Use RAG over current policy documents with region metadata instead of fine-tuning, the answer depends on documents that change often and need region-specific accuracy, and baking changing knowledge into model weights via fine-tuning is exactly what this lesson warns against","Fine-tuning is the ideal solution for any region-specific policy question, regardless of how often it changes","This question cannot be answered by RAG since RAG only works for policies that never change","Prompting alone, without RAG or fine-tuning, is the recommended solution for this scenario"]$D3e9c7a91_7ff1_4d9f_a835_a7e2211b8f4fQ$::jsonb where id = '3e9c7a91-7ff1-4d9f-a835-a7e2211b8f4f';

update questions set choices = $D2634d2af_ec98_4b81_b727_89f37529dc1fQ$["Fine-tuning cannot make a model know live information like a real-time account balance, since the answer depends on a system of record, a tool is needed instead, regardless of how much fine-tuning is applied","Fine-tuning is an effective way to teach a model live, constantly-changing account balances","This is a structured prediction problem that requires training a new traditional ML model instead of using a tool","Account balance questions cannot be answered by any method described in this lesson"]$D2634d2af_ec98_4b81_b727_89f37529dc1fQ$::jsonb where id = '2634d2af-ec98-4b81-b727-89f37529dc1f';

update questions set choices = $Dd8c4836e_0d04_4cea_8d5c_a5cae16879b8Q$["Use deterministic software instead, since the rules are clear, output must be exact, and this is fundamentally a calculation task, deterministic software is safer and more reliable here than fine-tuning a model, which can still make probabilistic errors on exact calculations","Fine-tuning is the best approach for any calculation task, including fixed-formula tax calculations","Model routing should send this task to the largest available reasoning model instead of deterministic code","This task cannot be solved by any method, AI-based or otherwise, according to this lesson"]$Dd8c4836e_0d04_4cea_8d5c_a5cae16879b8Q$::jsonb where id = 'd8c4836e-0d04-4cea-8d5c-a5cae16879b8';

update questions set choices = $D56acfe10_a26e_4063_af36_e2083b742527Q$["Use a commercial AI API, this fits when speed matters, general model quality is good, the internal ML team is small, and the team wants fast prototyping, all of which apply to this company's situation","Fine-tuning in-house is always the better choice for small ML teams regardless of speed needs","Building a custom model from scratch is the recommended path for any team without existing infrastructure","There is no meaningful difference between these options for a small team"]$D56acfe10_a26e_4063_af36_e2083b742527Q$::jsonb where id = '56acfe10-a26e-4063-af36-e2083b742527';

update questions set choices = $Dc45449d2_8688_4e8b_8c9d_97cb78b0f4b1Q$["Closed models reduce build complexity but come with less control and vendor dependency, while open-source or self-hosted models increase control (including data locality and custom deployment) but also increase ownership burden like infrastructure and ML ops complexity, this is exactly the tradeoff the team is now experiencing","Closed models always provide the same level of data locality and deployment control as open-source models","This tradeoff does not exist, since closed and open-source models are functionally identical in terms of control and complexity","Regulatory requirements around data locality can only ever be solved by fine-tuning, not by choice of model hosting"]$Dc45449d2_8688_4e8b_8c9d_97cb78b0f4b1Q$::jsonb where id = 'c45449d2-8688-4e8b-8c9d-97cb78b0f4b1';

update questions set choices = $Dde2e6e8f_7926_4dc2_97b3_d04340c10ec8Q$["This is a vibe-based evaluation, which this lesson specifically warns against, model evaluation should use task-specific evals that reflect real production distributions, including real user examples, edge cases, and hard cases, rather than relying on demo impressions","Demo performance is a fully reliable substitute for task-specific evaluation on real production data","Vibe-based evaluation is the recommended approach specifically for support AI products","Evaluation is unnecessary once a model has performed well in any demo setting"]$Dde2e6e8f_7926_4dc2_97b3_d04340c10ec8Q$::jsonb where id = 'de2e6e8f-7926-4dc2-97b3-d04340c10ec8';

update questions set choices = $D548f3589_98e6_47c0_9676_4df890be53aaQ$["A measured comparison against a baseline using the actual task metric, the lesson specifically asks whether fine-tuning improved the actual task metric, not just made outputs look nicer, which requires measuring baseline and post-fine-tuning performance on defined metrics like accuracy or format compliance","Nothing is missing, since outputs looking better is a sufficient basis for concluding fine-tuning was successful","This gap only matters for extraction tasks, not for other types of fine-tuning like classification","Subjective impressions of quality are always more reliable than measured metrics for evaluating fine-tuning success"]$D548f3589_98e6_47c0_9676_4df890be53aaQ$::jsonb where id = '548f3589-98e6-47c0-9676-4df890be53aa';

update questions set choices = $D4df1014e_68a0_4f98_865e_0fb3a99f3f42Q$["This is overfitting, the model memorized training examples instead of learning general behavior, shown by great training performance combined with weak test performance and failure on new wording, which is exactly the pattern described in this lesson","This is expected and desirable behavior for any well-fine-tuned model","This indicates the model needs more training on the exact same examples it already saw","This pattern only occurs in preference tuning, not in supervised fine-tuning"]$D4df1014e_68a0_4f98_865e_0fb3a99f3f42Q$::jsonb where id = '4df1014e-68a0-4f98-865e-0fb3a99f3f42';

update questions set choices = $Dd464f619_b43d_4e5f_94ff_0f66a82b04b9Q$["Run regression tests covering safety behavior, refusal behavior, policy compliance, format compliance, accuracy, bias/fairness, edge cases, and no-answer cases, since a fine-tuned model that improves on one dimension (tone) but regresses on another (policy accuracy) is not acceptable, and this can only be caught by explicitly testing for it","Improved tone scores alone are sufficient evidence that the fine-tuned model is ready to launch","Regression testing is only necessary for models that show a decline in the primary task metric, not for models that improve","Policy accuracy and safety behavior cannot be affected by fine-tuning that targets tone, so no additional testing is needed"]$Dd464f619_b43d_4e5f_94ff_0f66a82b04b9Q$::jsonb where id = 'd464f619-b43d-4e5f-94ff-0f66a82b04b9';

update questions set choices = $D267c5fb2_5f95_46cd_9bed_0e1b989d3195Q$["Whether this data is allowed for training, whether sensitive data has been removed or masked, who can access the training data, whether outputs could leak memorized details, and whether vendor policy allows this use, training data is product risk and must be treated carefully, especially with unredacted sensitive information like this","Nothing needs to be checked, since historical support tickets are always safe to use for training as-is","Privacy review is only required for healthcare or financial fine-tuning projects, not for general customer support","Redacting sensitive data would make the fine-tuning less effective, so it should be left unredacted"]$D267c5fb2_5f95_46cd_9bed_0e1b989d3195Q$::jsonb where id = '267c5fb2-5f95-46cd-9bed-0e1b989d3195';

update questions set choices = $D6d8f6a70_9d8a_473f_8c28_8afa73ec586aQ$["The model will likely learn the same inconsistency the annotators had, if humans cannot label consistently, the model cannot learn consistently, so proceeding without resolving the labeling disagreement will likely produce a similarly confused model","The fine-tuned model will automatically resolve the ambiguity and produce perfectly consistent categorization","Annotator disagreement has no impact on fine-tuning outcomes as long as there are enough total examples","This kind of disagreement only matters for preference tuning, not for supervised fine-tuning tasks like classification"]$D6d8f6a70_9d8a_473f_8c28_8afa73ec586aQ$::jsonb where id = '6d8f6a70-9d8a-473f-8c28-8afa73ec586a';

update questions set choices = $D1dbc5b10_1ded_4d11_a5ca_71745f9e4389Q$["This skips important steps in both the fine-tuning project plan and shadow mode testing, the recommended approach is to pilot in shadow mode or copilot mode and use a phased rollout before full deployment, so the team can catch problems (like disagreements with human judgment on real cases) before they affect all users","This is the recommended launch approach for any fine-tuned model with a good evaluation score","Shadow mode is only relevant for agent-based systems, not for fine-tuned classification models","A single evaluation pass is always sufficient to justify full production deployment with no phased rollout"]$D1dbc5b10_1ded_4d11_a5ca_71745f9e4389Q$::jsonb where id = '1dbc5b10-1ded-4d11-a5ca-71745f9e4389';

update questions set choices = $Db2dee736_55cd_4c33_b2c9_6de6bc1f8b9fQ$["This assumption is risky, fine-tuned model quality can degrade over time as user behavior changes, policies change, new categories appear, or data distribution shifts, so ongoing monitoring is needed to know when the model is no longer good enough, not just monitoring during the initial launch","This assumption is correct, since a well-fine-tuned model requires no further monitoring once launched successfully","Monitoring is only necessary if the initial evaluation showed poor results, not for models that launched successfully","Drift and distribution shift are concepts that only apply to traditional ML models, not to fine-tuned LLMs"]$Db2dee736_55cd_4c33_b2c9_6de6bc1f8b9fQ$::jsonb where id = 'b2dee736-55cd-4c33-b2c9-6de6bc1f8b9f';

update questions set choices = $D2ba0108f_a02d_4913_b70b_70f4dadad1f3Q$["Model versioning, tracking the base model, fine-tuning dataset version, training date, evaluation results, safety results, deployment date, owner, and rollback plan for each version, since without this, the team cannot trace or debug which version is actually running and why it might be behaving a certain way","Nothing is missing, since debugging a fine-tuned model does not require knowing which version or dataset was used","This problem can only be solved by retraining from scratch, not by improved versioning practices","Model versioning is only relevant for traditional ML models, not for fine-tuned LLMs"]$D2ba0108f_a02d_4913_b70b_70f4dadad1f3Q$::jsonb where id = '2ba0108f-a02d-4913-b70b-70f4dadad1f3';

update questions set choices = $D5b38b67e_4c12_4d6f_a16a_ec7d3a9cb8b0Q$["The value of even a large accuracy improvement scales with volume, this lesson's ROI example shows fine-tuning making strong business sense at 100,000 tickets per month, but at only 50 tickets per month, the same percentage-point improvement translates to far less absolute value, so the PM should weigh the fine-tuning cost against this much smaller realized benefit","The ROI is identical regardless of volume, since accuracy improvement alone determines whether fine-tuning was worthwhile","Fine-tuning is only worthwhile if the accuracy improvement exceeds 20 percentage points, regardless of volume","Volume has no bearing on fine-tuning ROI calculations according to this lesson"]$D5b38b67e_4c12_4d6f_a16a_ec7d3a9cb8b0Q$::jsonb where id = '5b38b67e-4c12-4d6f-a16a-ec7d3a9cb8b0';

update questions set question_text = $D2f4b1ec3_aed3_4ad4_8a4c_7ffe42478e45$A team building a support copilot uses only a single fine-tuned model for the entire feature, drafting replies, checking order status, retrieving policy, and validating tone, instead of combining multiple methods. What does this lesson's examples suggest about this design?$D2f4b1ec3_aed3_4ad4_8a4c_7ffe42478e45$ where id = '2f4b1ec3-aed3-4ad4-8a4c-7ffe42478e45';

update questions set choices = $D2f4b1ec3_aed3_4ad4_8a4c_7ffe42478e45Q$["Most real AI products combine multiple methods, the support copilot example in this lesson recommends RAG for policy, a tool for order status, a prompt for structure, fine-tuning for tone/format if justified by volume, and human approval, rather than relying on a single fine-tuned model to handle everything including things like live order status that fine-tuning cannot provide","A single fine-tuned model handling all of these responsibilities is the recommended and most efficient design according to this lesson","Order status lookups can be reliably handled by a sufficiently well fine-tuned model without any tool integration","Combining multiple methods is only relevant for internal analytics assistants, not for support copilots"]$D2f4b1ec3_aed3_4ad4_8a4c_7ffe42478e45Q$::jsonb where id = '2f4b1ec3-aed3-4ad4-8a4c-7ffe42478e45';

update questions set choices = $D1d18d021_003a_468d_bfb1_9a86445cd11eQ$["Consider dedicated recommendation and ranking approaches instead, this lesson notes that an LLM is usually not the core model for ranking products, and better tools include recommendation models, embeddings, ranking models, collaborative filtering, and learning-to-rank models, with the LLM playing a supporting role like explaining recommendations rather than doing the ranking itself","Fine-tuning a general-purpose LLM is the recommended and most effective approach for all product ranking tasks","Traditional recommendation and ranking models are obsolete and should always be replaced by fine-tuned LLMs","This decision has no meaningful tradeoffs, since any model type performs identically for ranking tasks"]$D1d18d021_003a_468d_bfb1_9a86445cd11eQ$::jsonb where id = '1d18d021-003a-468d-bfb1-9a86445cd11e';

update questions set choices = $Da230e5a8_1c87_4c01_891c_a31793c26188Q$["Work through the decision tree in order, check whether the task needs exact live data (use tools), company documents (use RAG), better instructions (use prompting), consistent behavior at scale (consider fine-tuning), structured prediction (use traditional ML), ranking (use a ranking model), cross-system actions (use an agent), or simple fixed rules (use deterministic software), and choose the simplest reliable solution that meets the quality bar","Skip directly to fine-tuning, since it is the most broadly capable option and can substitute for any of the other approaches","Always choose traditional ML first regardless of whether the task involves structured data or ranking","This decision cannot be made systematically and should be based on which method the team is most excited about"]$Da230e5a8_1c87_4c01_891c_a31793c26188Q$::jsonb where id = 'a230e5a8-1c87-4c01-891c-a31793c26188';

update questions set choices = $D19d82380_b8f4_4ee9_a435_46bafe2c865cQ$["No, the PM checklist before fine-tuning specifically requires defining the baseline, the metric that must improve, and the safety behavior that must not get worse before approving fine-tuning, and skipping these questions leaves the project without a way to know if it actually succeeded","Yes, since these details can be figured out after the fine-tuning is already complete","Yes, as long as the team has enough training examples, regardless of whether a baseline or safety criteria are defined","Baseline and safety criteria are only required for model selection decisions, not for fine-tuning approval"]$D19d82380_b8f4_4ee9_a435_46bafe2c865cQ$::jsonb where id = '19d82380-b8f4-4ee9-a435-46bafe2c865c';

update questions set choices = $Dfed64c45_f54e_4f79_96e6_67ae10cf948aQ$["Explain that fine-tuning is not usually the best way to add changing knowledge, and the team should first measure the base model with prompting and RAG; only if the model still fails in a repeated, measurable way, and high-quality examples exist, does fine-tuning make sense to improve consistency or reduce cost/latency, sounding \"more advanced\" does not make it the right first step","Fine-tuning should always be used first for any new AI feature since it is inherently more thorough and advanced than prompting or RAG","Prompting and RAG are outdated techniques that should be replaced entirely by fine-tuning in modern AI products","The choice between these approaches has no relationship to whether the task involves changing knowledge or stable, repeated behavior"]$Dfed64c45_f54e_4f79_96e6_67ae10cf948aQ$::jsonb where id = 'fed64c45-f54e-4f79-96e6-67ae10cf948a';
