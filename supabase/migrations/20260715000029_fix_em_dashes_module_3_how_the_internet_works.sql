...
-- Software Development with Claude Code / Module 3: How the Internet Works
-- Replaces markdown glossary "**Term** — Definition" with "**Term**: Definition",
-- and general prose " — " with ", ". Titles use " - " (spaced hyphen).

update modules set description = $M$Understand what happens when your browser opens a website, DNS, HTTP, HTTPS, APIs, latency, CDNs, and DevTools.$M$ where id = '766e4046-fdc1-4625-b8e7-59e5deb57fb2';

update lessons set content = $D6794ff92_f22c_4219_904f_96443b0af821$When you type a website address and press Enter, it feels instant.
...
**Internet:** The network that connects computers around the world.$D6794ff92_f22c_4219_904f_96443b0af821$ where id = '6794ff92-f22c-4219-904f-96443b0af821';

update lessons set content = $D78d60aca_75f1_404d_aff9_3ce6412503a6$Almost everything on the internet starts with a simple pattern.
...
[!] Your current webpage from Module 2 is still a local file. It does not yet talk to a server. In this module, you will change that, your page will make a real request to another system.$D78d60aca_75f1_404d_aff9_3ce6412503a6$ where id = '78d60aca-75f1-404d-aff9-3ce6412503a6';

update lessons set content = $D11982bb6_4a10_44c8_96fe_36c201c32463$Humans like names. Computers use addresses.
...
You may see an IP address next to the domain name. The concept matters more than the command. If ping does not work on your network, skip it.$D11982bb6_4a10_44c8_96fe_36c201c32463$ where id = '11982bb6-4a10-44c8-96fe-36c201c32463';

update lessons set content = $D2ef13d0e_63a3_484a_9bcb_dfb0b1a4375e$Once your browser knows which server to contact, it needs a way to speak to it.
...
Answers: GET, POST, PUT, DELETE$D2ef13d0e_63a3_484a_9bcb_dfb0b1a4375e$ where id = '2ef13d0e-63a3-484a-9bcb-dfb0b1a4375e';

update lessons set content = $Dfa73db0c_349c_435f_a2d7_b94d32987976$When a server responds to a request, it includes a **status code**.
...
That makes you much more effective in technical conversations.$Dfa73db0c_349c_435f_a2d7_b94d32987976$ where id = 'fa73db0c-349c-435f-a2d7-b94d32987976';

update lessons set content = $D84513556_707a_47c6_998b_bf16162e165b$You have probably noticed that websites start with:
  https://
...
If your app has a login page, it must use HTTPS. A login form over plain HTTP would be unsafe because the user's password could travel without protection. For a real product, HTTPS is not optional.$D84513556_707a_47c6_998b_bf16162e165b$ where id = '84513556-707a-47c6-998b-bf16162e165b';

update lessons set content = $D2232f736_32d1_4615_9aa1_e8701b244040$Sometimes an app feels fast. Sometimes it feels slow.
...
**Rendering time:** Time the browser spends drawing the page.$D2232f736_32d1_4615_9aa1_e8701b244040$ where id = '2232f736-32d1-4615-9aa1-e8701b244040';

update lessons set content = $D7521a627_b4d5_4548_b86d_3e0e5b87c7f1$If users are spread across the world, should every user download files from one central server?
...
As a product builder, the main idea is:
  Put common files closer to users.$D7521a627_b4d5_4548_b86d_3e0e5b87c7f1$ where id = '7521a627-b4d5-4548-b86d-3e0e5b87c7f1';

update lessons set content = $D465c2469_b296_4e86_bda3_20e8219efcde$So far, your webpage mostly uses files on your computer.
...
Public test APIs can sometimes be unavailable or change behavior. If an API in this lesson does not work, ask Claude or ChatGPT:
  ...
  "Give me a current beginner-friendly public test API that supports browser fetch. I want to practice GET requests and display JSON data on a simple webpage."$D465c2469_b296_4e86_bda3_20e8219efcde$ where id = '465c2469-b296-4e86-bda3-20e8219efcde';

update lessons set content = $Dc775af74_3048_455a_8484_4efeafbd3a18$When your browser talks to a server, the conversation is usually invisible.
...
[!] If you are confused by what you see in the Network tab, take a screenshot and ask Claude or ChatGPT: "I am looking at the Network tab. Please explain what each visible request represents and what I should check."$Dc775af74_3048_455a_8484_4efeafbd3a18$ where id = 'c775af74-3048-455a-8484-4efeafbd3a18';

update lessons set content = $Dd6b3d871_8f1f_41f6_918e_7e653b2dca42$Now you will upgrade your first webpage.
...
Answer these before moving on:
  ...
  9. What is an API?
  10. What did your webpage fetch from the internet?$Dd6b3d871_8f1f_41f6_918e_7e653b2dca42$ where id = 'd6b3d871-8f1f-41f6-918e-7e653b2dca42';
