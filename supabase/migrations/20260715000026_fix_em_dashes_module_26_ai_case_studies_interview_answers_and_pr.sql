...
update modules set description = $M$The capstone module, five full product case studies, a ten-question interview answer bank, practice-question drills, reusable PM answer templates, and a final capstone project that turn everything in this course into interview-ready judgment.$M$ where id = '5aa2ae8e-201f-4d00-acda-d66bd92fe7e0';

update lessons set title = $Ddcce2b6b_b8df_43a2_a481_dc550484487e$Case Study 2: Internal Knowledge Assistant - Product Problem and AI Solution$Ddcce2b6b_b8df_43a2_a481_dc550484487e$ where id = 'dcce2b6b-b8df-43a2-a481-dc550484487e';

update lessons set content = $Ddcce2b6b_b8df_43a2_a481_dc550484487e$PRODUCT PROBLEM
...
>> Compare this to the support copilot in the previous case study, same RAG-based approach, but a completely different user and a completely different risk profile.$Ddcce2b6b_b8df_43a2_a481_dc550484487e$ where id = 'dcce2b6b-b8df-43a2-a481-dc550484487e';

update lessons set content = $Da711186d_06a1_455b_b796_510cecd8fb16$WHY THIS MODULE MATTERS
...
>> Problem, then workflow, then AI role, then data, then UX, then evaluation, then guardrails, then business impact, that chain is the spine of every strong AI PM answer in this module.$Da711186d_06a1_455b_b796_510cecd8fb16$ where id = 'a711186d-06a1-455b-b796-510cecd8fb16';

update lessons set content = $D6994cba0_1756_4960_80c9_958d714271c5$THE MASTER AI PM FRAMEWORK
...
>> Every strong answer names the user problem, the workflow, and the AI's specific role before it ever mentions a model or a technology.$D6994cba0_1756_4960_80c9_958d714271c5$ where id = '6994cba0-1756-4960-80c9-958d714271c5';

update lessons set content = $De02e4f64_5ba7_4405_94c8_2df6c4e826b8$STEP 4: IDENTIFY DATA AND CONTEXT
...
>> This course has already covered every one of these architecture options in earlier modules, this framework is where they get applied to real problems instead of studied in isolation.$De02e4f64_5ba7_4405_94c8_2df6c4e826b8$ where id = 'e02e4f64-5ba7-4405-94c8-2df6c4e826b8';

update lessons set content = $Dd6bb5a81_8b56_40eb_ac5e_637bb8fe9abd$STEP 7: DEFINE METRICS
...
>> The five case studies, ten interview answers, and five templates that follow in this module are all instances of this same ten-step shape, once you know the framework, you can generate a strong answer to almost any AI PM question.$Dd6bb5a81_8b56_40eb_ac5e_637bb8fe9abd$ where id = 'd6bb5a81-8b56-40eb-ac5e-637bb8fe9abd';

update lessons set title = $D4b4889b6_69bf_44f0_a27f_419feeed92a0$Case Study 1: Support Copilot - Product Problem and AI Solution$D4b4889b6_69bf_44f0_a27f_419feeed92a0$ where id = '4b4889b6-69bf-44f0-a27f-419feeed92a0';

update lessons set content = $D4b4889b6_69bf_44f0_a27f_419feeed92a0$PRODUCT PROBLEM
...
>> This is the same support copilot build example introduced in Module 25, now reframed as a full case study you can walk an interviewer through end to end.$D4b4889b6_69bf_44f0_a27f_419feeed92a0$ where id = '4b4889b6-69bf-44f0-a27f-419feeed92a0';

update lessons set title = $Dfbbe4884_1e66_4b9e_82d5_259cad1d373a$Case Study 1: Support Copilot - Architecture and UX Design$Dfbbe4884_1e66_4b9e_82d5_259cad1d373a$ where id = 'fbbe4884-1e66-4b9e-82d5-259cad1d373a';

update lessons set content = $Dfbbe4884_1e66_4b9e_82d5_259cad1d373a$BEST ARCHITECTURE
...
>> Architecture without the right UX fails just as often as UX without the right architecture, this case study pairs both deliberately.$Dfbbe4884_1e66_4b9e_82d5_259cad1d373a$ where id = 'fbbe4884-1e66-4b9e-82d5-259cad1d373a';

update lessons set title = $Dc18d283e_0769_4f4f_94ce_2c8f5904a5ca$Case Study 1: Support Copilot - Metrics and Interview Answer$Dc18d283e_0769_4f4f_94ce_2c8f5904a5ca$ where id = 'c18d283e-0769-4f4f-94ce-2c8f5904a5ca';

update lessons set content = $Dc18d283e_0769_4f4f_94ce_2c8f5904a5ca$METRICS
...
>> This interview answer is the template: state the workflow insight first, then architecture, then rollout posture, then metrics, then guardrails, in that order.$Dc18d283e_0769_4f4f_94ce_2c8f5904a5ca$ where id = 'c18d283e-0769-4f4f-94ce-2c8f5904a5ca';

update lessons set title = $D2ed29371_c508_4796_9f64_5d3681df82f9$Case Study 2: Internal Knowledge Assistant - Architecture and Key Risks$D2ed29371_c508_4796_9f64_5d3681df82f9$ where id = '2ed29371-c508-4796-9f64-5d3681df82f9';

update lessons set content = $D2ed29371_c508_4796_9f64_5d3681df82f9$BEST ARCHITECTURE
...
>> Every risk in this list maps back to a layer from Module 25, source freshness maps to versioning, permission leaks map to permission-aware retrieval, and fake citations map to output guardrails.$D2ed29371_c508_4796_9f64_5d3681df82f9$ where id = '2ed29371-c508-4796-9f64-5d3681df82f9';

update lessons set title = $D5d87a34b_07a2_4a47_9cee_0e7376f0bc8f$Case Study 2: Internal Knowledge Assistant - Metrics and Interview Answer$D5d87a34b_07a2_4a47_9cee_0e7376f0bc8f$ where id = '5d87a34b-07a2-4a47-9cee-0e7376f0bc8f';

update lessons set content = $D5d87a34b_07a2_4a47_9cee_0e7376f0bc8f$METRICS
...
>> This interview answer opens with a RAG-vs-fine-tuning judgment call, that pairing is common enough in interviews that it deserves its own answer, covered two lessons from now in the interview answer bank.$D5d87a34b_07a2_4a47_9cee_0e7376f0bc8f$ where id = '5d87a34b-07a2-4a47-9cee-0e7376f0bc8f';

update lessons set title = $Dd669ba64_e27a_4d49_ab2a_5896d68390ec$Case Study 3: AI Refund Agent - Product Problem and AI Solution$Dd669ba64_e27a_4d49_ab2a_5896d68390ec$ where id = 'd669ba64-e27a-4d49-ab2a-5896d68390ec';

update lessons set content = $Dd669ba64_e27a_4d49_ab2a_5896d68390ec$PRODUCT PROBLEM
...
>> This is the same refund agent build example from Module 25, the case-study format now adds the product framing and interview-ready language around it.$Dd669ba64_e27a_4d49_ab2a_5896d68390ec$ where id = 'd669ba64-e27a-4d49-ab2a-5896d68390ec';

update lessons set title = $D44d56c54_5a5f_4a3e_949c_02071dd5aff7$Case Study 3: AI Refund Agent - Architecture$D44d56c54_5a5f_4a3e_949c_02071dd5aff7$ where id = '44d56c54-5a5f-4a3e-949c-02071dd5aff7';

update lessons set content = $D44d56c54_5a5f_4a3e_949c_02071dd5aff7$BEST ARCHITECTURE
...
>> This threshold pattern is the deterministic-rules-vs-AI decision from Module 25, applied concretely: AI drafts and recommends, rules gate what can happen automatically.$D44d56c54_5a5f_4a3e_949c_02071dd5aff7$ where id = '44d56c54-5a5f-4a3e-949c-02071dd5aff7';

update lessons set title = $D72bdeb7d_0d99_447d_98bb_fcd9002d3348$Case Study 3: AI Refund Agent - Metrics and Interview Answer$D72bdeb7d_0d99_447d_98bb_fcd9002d3348$ where id = '72bdeb7d-0d99-447d-98bb-fcd9002d3348';

update lessons set content = $D72bdeb7d_0d99_447d_98bb_fcd9002d3348$METRICS
...
>> Four metric categories again, efficiency, quality, safety, customer, the same shape as the support copilot case study, reused because it works for any AI feature with real-world consequences.$D72bdeb7d_0d99_447d_98bb_fcd9002d3348$ where id = '72bdeb7d-0d99-447d-98bb-fcd9002d3348';

update lessons set title = $De892e11e_7fcb_43d5_8b97_620d5eba899d$Case Study 4: AI Analytics Assistant - Product Problem and AI Solution$De892e11e_7fcb_43d5_8b97_620d5eba899d$ where id = 'e892e11e-7fcb-43d5-8b97-620d5eba899d';

update lessons set content = $De892e11e_7fcb_43d5_8b97_620d5eba899d$PRODUCT PROBLEM
...
>> This is the fourth of five case studies in this module, notice each one pairs a workflow bottleneck with a specific, scoped AI role, never a vague "AI-powered" pitch.$De892e11e_7fcb_43d5_8b97_620d5eba899d$ where id = 'e892e11e-7fcb-43d5-8b97-620d5eba899d';

update lessons set title = $Dd5f57f74_6d45_4c85_a6fc_45bf2421dbe5$Case Study 4: AI Analytics Assistant - Architecture$Dd5f57f74_6d45_4c85_a6fc_45bf2421dbe5$ where id = 'd5f57f74-6d45-4c85-a6fc-45bf2421dbe5';

update lessons set content = $Dd5f57f74_6d45_4c85_a6fc_45bf2421dbe5$BEST ARCHITECTURE
...
>> An analytics assistant is one of the clearest cases in this whole course for why "the model is not the source of truth", the database is, and the model's job is to reach it correctly.$Dd5f57f74_6d45_4c85_a6fc_45bf2421dbe5$ where id = 'd5f57f74-6d45-4c85-a6fc-45bf2421dbe5';

update lessons set title = $D84616870_ac34_416e_b6f9_97f437377fc8$Case Study 4: AI Analytics Assistant - Metrics and Interview Answer$D84616870_ac34_416e_b6f9_97f437377fc8$ where id = '84616870-ac34-416e-b6f9-97f437377fc8';

update lessons set content = $D84616870_ac34_416e_b6f9_97f437377fc8$METRICS
...
>> Notice this interview answer never mentions a specific model or vendor, it stays entirely at the level of architecture and product judgment, which is exactly what a strong PM answer should do.$D84616870_ac34_416e_b6f9_97f437377fc8$ where id = '84616870-ac34-416e-b6f9-97f437377fc8';

update lessons set title = $D74ced33c_0d59_4339_ba8e_579e69bac2e5$Case Study 5: AI Learning Coach - Product Problem and AI Solution$D74ced33c_0d59_4339_ba8e_579e69bac2e5$ where id = '74ced33c-0d59-4339-ba8e-579e69bac2e5';

update lessons set content = $D74ced33c_0d59_4339_ba8e_579e69bac2e5$PRODUCT PROBLEM
...
>> The fifth and final case study in this module, after this, the module shifts from case studies into interview answer banks, practice questions, and templates.$D74ced33c_0d59_4339_ba8e_579e69bac2e5$ where id = '74ced33c-0d59-4339-ba8e-579e69bac2e5';

update lessons set title = $D13e6aae7_b797_45b2_b60a_019b5859bcf1$Case Study 5: AI Learning Coach - Architecture$D13e6aae7_b797_45b2_b60a_019b5859bcf1$ where id = '13e6aae7-b797-45b2-b60a-019b5859bcf1';

update lessons set content = $D13e6aae7_b797_45b2_b60a_019b5859bcf1$BEST ARCHITECTURE
...
>> This architecture combines four patterns from earlier in the course: RAG for content grounding, a recommendation system for next-lesson logic, traditional scoring for quizzes, and human review for the highest-stakes assessments.$D13e6aae7_b797_45b2_b60a_019b5859bcf1$ where id = '13e6aae7-b797-45b2-b60a-019b5859bcf1';

update lessons set title = $D861371f4_3acf_4480_a77e_c7de8f84ee9d$Case Study 5: AI Learning Coach - Metrics and Interview Answer$D861371f4_3acf_4480_a77e_c7de8f84ee9d$ where id = '861371f4-3acf-4480-a77e-c7de8f84ee9d';

update lessons set content = $D861371f4_3acf_4480_a77e_c7de8f84ee9d$METRICS
...
>> This closes the five-case-study arc: support copilot, knowledge assistant, refund agent, analytics assistant, learning coach, five different user problems, the same ten-step framework applied to each.$D861371f4_3acf_4480_a77e_c7de8f84ee9d$ where id = '861371f4-3acf-4480-a77e-c7de8f84ee9d';

update lessons set content = $Dae49ba4c_5cc3_4338_b229_9b587a290724$QUESTION: HOW WOULD YOU DECIDE WHETHER TO USE AI IN A PRODUCT?
...
>> These two questions open the interview answer bank because they are the two most commonly asked "when would you use X" questions in AI PM interviews.$Dae49ba4c_5cc3_4338_b229_9b587a290724$ where id = 'ae49ba4c-5cc3-4338-b229-9b587a290724';

update lessons set content = $D40860b66_aede_4413_a81f_a831732720aa$QUESTION: HOW WOULD YOU EVALUATE AN LLM FEATURE?
...
>> The three-level evaluation structure, output quality, system behavior, product impact, works as a template for evaluating almost any AI feature, not just LLM ones.$D40860b66_aede_4413_a81f_a831732720aa$ where id = '40860b66-aede-4413-a81f-a831732720aa';

update lessons set content = $Defa60a10_c01a_4c56_a373_57278c4f5d6f$QUESTION: HOW WOULD YOU DESIGN AN AI AGENT SAFELY?
...
>> Notice the agent-safety answer's staged rollout, internal test, shadow mode, draft-only, low-risk automation, broader rollout, is the same five-stage ladder from Module 25's deployment architecture lesson.$Defa60a10_c01a_4c56_a373_57278c4f5d6f$ where id = 'efa60a10-c01a-4c56-a373-57278c4f5d6f';

update lessons set content = $D751037ed_0333_4d7a_994e_aee10df787a9$QUESTION: WHEN SHOULD AI BE HUMAN-IN-THE-LOOP?
...
>> "Gradually automate while keeping escalation for exceptions" is the same idea as the refund agent's tiered thresholds, a recurring pattern worth recognizing across every case study in this module.$D751037ed_0333_4d7a_994e_aee10df787a9$ where id = '751037ed-0333-4d7a-994e-aee10df787a9';

update lessons set content = $D1289d657_03ef_4817_938d_073b11d7d979$QUESTION: WHAT ARE THE BIGGEST RISKS IN AI PRODUCTS?
...
>> This closes the ten-question interview answer bank, five pairs of questions, each pairing a "how would you..." judgment question with a concrete, memorizable answer.$D1289d657_03ef_4817_938d_073b11d7d979$ where id = '1289d657-03ef-4817-938d-073b11d7d979';

update lessons set content = $De053672b_7c85_49bf_a971_c271f848fdfa$AI PRODUCT DESIGN QUESTIONS
...
>> These ten design prompts and ten strategy prompts are meant to be practiced out loud, not just read, treat each one as a two-minute spoken drill.$De053672b_7c85_49bf_a971_c271f848fdfa$ where id = 'e053672b-7c85-49bf-a971-c271f848fdfa';

update lessons set content = $Dbd61be02_f411_4606_93de_2359c4be1095$WHAT YOU NOW KNOW
...
>> Twenty-five modules of technical building blocks and product judgment are now behind you, the next two lessons distill all of it down to what actually needs to stay memorized.$Dbd61be02_f411_4606_93de_2359c4be1095$ where id = 'bd61be02-f411-4606-93de-2359c4be1095';

update lessons set content = $D19c7fc6f_9b6f_479c_aba7_d7086bf1402c$AI EXECUTION QUESTIONS
...
>> Three question types in one lesson, execution, metrics, technical judgment, because interviewers often blend all three into a single follow-up chain after your initial case study answer.$D19c7fc6f_9b6f_479c_aba7_d7086bf1402c$ where id = '19c7fc6f-9b6f-479c-aba7-d7086bf1402c';

update lessons set content = $Db3fcbdd1_20b7_47e2_b505_79ab787eab00$TEMPLATE: AI FEATURE PROPOSAL
...
>> "Add test cases to the golden dataset so the failure does not repeat" is the line every debugging answer should end on, it shows the fix is systemic, not a one-off patch.$Db3fcbdd1_20b7_47e2_b505_79ab787eab00$ where id = 'b3fcbdd1-20b7-47e2-b505-79ab787eab00';

update lessons set content = $Deaf4bb7c_214a_4091_a723_00205c1a893b$TEMPLATE: AI SAFETY ANSWER
...
>> Five templates across these two lessons, feature proposal, debugging, safety, RAG, agent, cover nearly every follow-up question an interviewer can ask after your opening case study answer.$Deaf4bb7c_214a_4091_a723_00205c1a893b$ where id = 'eaf4bb7c-214a-4091-a723-00205c1a893b';

update lessons set content = $Dc79e7a43_6ec8_4d6a_9540_f882f0e756de$CAPSTONE: DESIGN AN AI SUPPORT COPILOT
...
>> This capstone deliberately reuses the support copilot scenario from the first case study in this module, the difference now is that you generate the full fifteen-part answer yourself before checking it against the sample in the next lesson.$Dc79e7a43_6ec8_4d6a_9540_f882f0e756de$ where id = 'c79e7a43-6ec8-4d6a-9540-f882f0e756de';

update lessons set content = $Da2dc58e4_9f26_413a_adbd_1304a21ba5cc$Sample answer: "I would build a support copilot inside the agent console. The main user is the support agent, and the key pain is time spent reading long ticket histories, searching policy, and drafting responses. The AI should summarize the ticket, retrieve the relevant approved policy, check order/account data through tools, draft a response, and flag risky cases.
...
>> This sample answer is longer than any single interview answer earlier in this module because a capstone combines all of them, feature proposal, RAG design, safety posture, and ROI, into one continuous narrative.$Da2dc58e4_9f26_413a_adbd_1304a21ba5cc$ where id = 'a2dc58e4-9f26-413a-adbd-1304a21ba5cc';

update lessons set content = $Ddd2ed095_7281_4e30_9d92_a40f6330c7f4$1. **START WITH THE PROBLEM, NOT THE MODEL.** Bad: "let's use AI." Good: "which workflow is slow, expensive, risky, or painful?"
...
>> Notice these ten ideas map almost one-to-one onto the ten-step master framework from earlier in this module, that is not a coincidence, it is the same judgment restated as principles instead of steps.$Ddd2ed095_7281_4e30_9d92_a40f6330c7f4$ where id = 'dd2ed095-7281-4e30-9d92-a40f6330c7f4';

update lessons set content = $D55189276_8fe5_4fd0_92ac_4e11488531d7$For any AI product, remember this full chain: **user problem, then workflow, then AI role, then data/context, then architecture, then UX, then metrics, then guardrails, then rollout, then ROI.**
...
>> The final PM question: **does this AI product solve a real workflow problem better than the old way, safely, measurably, and with user trust?** Every case study, every interview answer, and every template in this module is just a different way of answering that one question.$D55189276_8fe5_4fd0_92ac_4e11488531d7$ where id = '55189276-8fe5-4fd0-92ac-4e11488531d7';

update questions set choices = $D109d88fe_7fed_40c1_84c7_4b371df8abefQ$["A weak AI PM answer starts with the model, a strong answer starts with the user problem, then works through workflow, AI role, data, UX, evaluation, guardrails, and business impact","Nothing is wrong, naming the specific model and technique first is the strongest way to open any AI PM answer","GPT and vector embeddings are never appropriate technology choices to mention in an interview","Starting with the model is fine as long as the answer is technically accurate"]$D109d88fe_7fed_40c1_84c7_4b371df8abefQ$::jsonb where id = '109d88fe-7fed-40c1-84c7-4b371df8abef';

update questions set choices = $Dfcc049f3_bc05_4a4d_8635_0f1ce2daba2dQ$["Defining the user problem, mapping the current workflow and its bottleneck, and choosing the AI's specific role (summarize, retrieve, draft, classify, extract, recommend, predict, or act) before any technology is named","Choosing the model, since model selection is step 1 of the framework","Designing the UX, since interface design should always precede problem definition","Nothing needs to come first, architecture and problem definition can be decided in any order"]$Dfcc049f3_bc05_4a4d_8635_0f1ce2daba2dQ$::jsonb where id = 'fcc049f3-bc05-4a4d-8635-0f1ce2daba2d';

update questions set choices = $D1c5f8b14_9ba4_4781_a76d_87f0c206c890Q$["Architecture and UX should be chosen after data is scoped, you cannot pick RAG vs. fine-tuning vs. tools until you know what context the AI actually needs","Architecture should always be chosen first, before identifying what data or context is required","Data and context only matter for fine-tuning decisions, not for RAG or tool-calling decisions","UX should be designed before the user problem is defined, and architecture chosen after that"]$D1c5f8b14_9ba4_4781_a76d_87f0c206c890Q$::jsonb where id = '1c5f8b14-9ba4-4781-a76d-87f0c206c890';

update questions set choices = $Dc34311c7_f786_4003_9083_57d2681b4911Q$["Knowledge is fragmented and stale, scattered across documents, wikis, Slack threads, PDFs, and old process pages, rather than any lack of underlying intelligence in the organization","Employees lack the intelligence needed to find answers on their own, regardless of how the knowledge is organized","There are too few employees to answer questions quickly, and AI is needed to add headcount","The company has no internal documentation at all, so an assistant must generate policy from scratch"]$Dc34311c7_f786_4003_9083_57d2681b4911Q$::jsonb where id = 'c34311c7-f786-4003-9083-57d2681b4911';

update questions set choices = $D784c1b4a_21b7_44ca_878f_cdd04653d552Q$["Over-trust is a UX and communication problem, not just an accuracy problem, even a well-functioning system can be trusted more than its actual reliability warrants if the UX doesn't clearly communicate confidence and sourcing","Over-trust is not actually a risk, and this framing was included only for completeness","This risk only applies to systems that are frequently wrong, not to well-functioning ones","Over-trust can only be solved by improving retrieval accuracy, not by any UX or communication change"]$D784c1b4a_21b7_44ca_878f_cdd04653d552Q$::jsonb where id = '784c1b4a-21b7-44ca-878f-cdd04653d552';

update questions set choices = $Df03d6b2d_bfcd_4e65_b760_0d115975d4b3Q$["The solution deliberately separates \"handle\" from \"escalate\", a refund agent that tries to handle everything is a liability, not a feature","Handling every refund request automatically is the ideal design, since it maximizes automation coverage","Escalation should only be used for requests the model cannot understand linguistically, not for high-risk cases","A refund agent should never be allowed to handle any case automatically, even low-risk ones"]$Df03d6b2d_bfcd_4e65_b760_0d115975d4b3Q$::jsonb where id = 'f03d6b2d-bfcd-4e65-b760-0d115975d4b3';

update questions set choices = $Dd098d276_8de4_4744_8014_f304e4e13f29Q$["The specific dollar amounts are not the important part, what matters is that a fixed rule, not the model's judgment, decides which tier a case falls into, since thresholds should be enforced in code, not just prompts","The exact dollar thresholds of $50 and $500 are universal best practices that every refund agent should use","The LLM should decide which tier a case falls into, since it can reason about eligibility more flexibly than fixed rules","Deterministic rules are unnecessary once tool permissions and audit logs are in place"]$Dd098d276_8de4_4744_8014_f304e4e13f29Q$::jsonb where id = 'd098d276-8de4-4744-8014-f304e4e13f29';

update questions set choices = $D7c3a1a67_5efc_43fd_8d48_a81ab63dc3ceQ$["The model is not the source of truth for numbers, the database is, and the model's job is to reach it correctly, so its generated queries should never touch real data unvalidated","SQL validation is an optional nice-to-have that does not affect whether the model can invent numbers","The model should be trusted to execute queries directly against production data without any intermediate validation","Validation is only useful for catching syntax errors, not for preventing the model from inventing numbers"]$D7c3a1a67_5efc_43fd_8d48_a81ab63dc3ceQ$::jsonb where id = '7c3a1a67-5efc-43fd-8d48-a81ab63dc3ce';

update questions set choices = $Dca72b5cb_ffd1_47e5_8bde_662d5d47c7a5Q$["It describes the exact kind of product this course itself is an example of, a lesson-and-quiz platform with adaptive elements","It is the only case study in the module that involves any form of retrieval or grounding","It is the only case study where human review plays any role in the architecture","It is identical in architecture and risk profile to the support copilot case study"]$Dca72b5cb_ffd1_47e5_8bde_662d5d47c7a5Q$::jsonb where id = 'ca72b5cb-ffd1-47e5-8bde-662d5d47c7a5';

update questions set question_text = $Da53f7691_b0fe_448b_a7ba_6de8c6ada3b4$A candidate is asked "RAG vs. fine-tuning, when would you use each?" What is the strong answer's simple memory rule from this lesson?$Da53f7691_b0fe_448b_a7ba_6de8c6ada3b4$ where id = 'a53f7691-b0fe-448b-a7ba-6de8c6ada3b4';

update questions set choices = $Da53f7691_b0fe_448b_a7ba_6de8c6ada3b4Q$["RAG gives knowledge at answer time, while fine-tuning changes behavior, use RAG for current, private, or company-specific knowledge, and fine-tuning for consistent output on a repeated task","RAG and fine-tuning are interchangeable and either can be used for any AI use case with equivalent results","Fine-tuning should always be used first, and RAG only added later if fine-tuning proves insufficient","RAG is only for customer-facing products, and fine-tuning is only for internal tools"]$Da53f7691_b0fe_448b_a7ba_6de8c6ada3b4Q$::jsonb where id = 'a53f7691-b0fe-448b-a7ba-6de8c6ada3b4';

update questions set choices = $D3d62ea8d_cf16_4348_bd0a_976ebff9f662Q$["When mistakes are costly, output is customer-facing, money or access is affected, legal/compliance risk exists, or model confidence is low, with gradual automation possible later for consistently accurate low-risk cases","Human-in-the-loop should be used for every single AI feature regardless of risk level, with no exceptions","Human-in-the-loop is only relevant for agents that call tools, never for features that only draft text","Once a feature launches, human review should be removed permanently regardless of ongoing accuracy"]$D3d62ea8d_cf16_4348_bd0a_976ebff9f662Q$::jsonb where id = '3d62ea8d-cf16-4348-bd0a-976ebff9f662';

update questions set choices = $D41b7f5a3_79d8_4f0f_ada4_0eac1e9a0bc6Q$["Pairing each named risk directly with a named mitigation, for example, RAG and citations for grounding, permission-aware retrieval for privacy, tool restrictions for agents, rather than just listing risks in isolation","Listing as many risks as possible without connecting them to specific mitigations, since breadth alone signals rigor","Focusing only on hallucination, since it is the single risk that matters most across all AI products","Avoiding any mention of mitigations, since interviewers prefer risk-only answers over risk-and-mitigation answers"]$D41b7f5a3_79d8_4f0f_ada4_0eac1e9a0bc6Q$::jsonb where id = '41b7f5a3-79d8-4f0f-ada4-0eac1e9a0bc6';

update questions set choices = $D37954aab_20a1_4db1_b225_4868724f70eeQ$["\"First, I would identify the failure mode\", rather than guessing at a fix before diagnosing what actually went wrong","A specific fix, such as switching to a larger model, without first identifying the failure mode","A recommendation to disable the AI feature entirely until the root cause is found through unrelated means","Increasing the AI feature's budget, since more resources always resolve execution problems"]$D37954aab_20a1_4db1_b225_4868724f70eeQ$::jsonb where id = '37954aab-20a1-4db1-b225-4868724f70ee';

update questions set choices = $D26141584_4dce_49ce_8227_1b80b4fd6c7dQ$["To match autonomy to evidence and risk, applying stronger controls like approval, tool restrictions, and audit logs specifically when AI affects money, access, legal, health, employment, safety, or customer communication","To prevent AI from being used in any customer-facing or money-affecting workflow, regardless of evidence","To apply the same fixed set of controls uniformly to every AI feature regardless of its risk level","To eliminate human review entirely once red-team testing and monitoring are in place"]$D26141584_4dce_49ce_8227_1b80b4fd6c7dQ$::jsonb where id = '26141584-4dce-49ce-8227-1b80b4fd6c7d';

update questions set choices = $D7885f34e_7ba5_4569_ab0d_d5f9c63b55cbQ$["A capstone combines multiple templates, feature proposal, RAG design, safety posture, and ROI, into one continuous narrative, unlike a single-question interview answer","The sample answer is intentionally padded with unnecessary detail that should be trimmed in a real interview","Capstone answers should always be shorter than single-question interview answers, and this one is an exception to avoid","Length has no relationship to how many templates or elements an answer combines"]$D7885f34e_7ba5_4569_ab0d_d5f9c63b55cbQ$::jsonb where id = '7885f34e-7ba5-4569-ab0d-d5f9c63b55cb';

update questions set choices = $D47ab7192_13dc_413f_b978_3d4a5ae1bd54Q$["User problem, then workflow, then AI role, then data/context, then architecture, then UX, then metrics, then guardrails, then rollout, then ROI, closing with the question of whether the AI product solves a real workflow problem better than the old way, safely, measurably, and with user trust","Model, then architecture, then UX, then metrics, closing with the question of whether the model is the most advanced one available","Data, then model, then evaluation, closing with the question of whether the model achieves the highest possible benchmark score","UX, then adoption, then revenue, closing with the question of whether the feature can be marketed as AI-powered"]$D47ab7192_13dc_413f_b978_3d4a5ae1bd54Q$::jsonb where id = '47ab7192-13dc-413f-b978-3d4a5ae1bd54';
